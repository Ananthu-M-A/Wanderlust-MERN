...
exports.createBookingMail = void 0;
require("dotenv/config");
const createBookingMail = (newBooking, user, hotel, restaurant) => {
    try {
        ...
        const emailContent = `
    Dear ${firstName !== null && firstName !== void 0 ? firstName : ''} ${lastName !== null && lastName !== void 0 ? lastName : ''},
    ...
    Guest Name: ${firstName !== null && firstName !== void 0 ? firstName : ''} ${lastName !== null && lastName !== void 0 ? lastName : ''}
...
exports.createBookingMail = createBookingMail;
